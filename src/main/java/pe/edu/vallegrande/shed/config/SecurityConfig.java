    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        // ==================== SHED ENDPOINTS ====================
                        .pathMatchers(HttpMethod.GET, "/NPH/sheds").hasAnyRole("USER", "ADMIN")
                        .pathMatchers(HttpMethod.POST, "/NPH/sheds").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/NPH/sheds/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/NPH/sheds/logic/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/NPH/sheds/restore/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/NPH/sheds/**").hasRole("ADMIN")
