package pe.edu.vallegrande.Product.config;
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.GET, "/NPH/products/**").hasAnyRole("USER", "ADMIN")
                        .pathMatchers(HttpMethod.POST, "/NPH/products/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/NPH/products/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/NPH/products/**").hasRole("ADMIN")
