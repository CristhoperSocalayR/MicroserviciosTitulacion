    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.GET, "/NPH/movement-kardex/**").hasAnyRole("USER", "ADMIN")
                        .pathMatchers(HttpMethod.POST, "/NPH/movement-kardex/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/NPH/movement-kardex/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/NPH/movement-kardex/**").hasRole("ADMIN")
